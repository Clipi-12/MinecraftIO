...
public class BlockState implements NestedToString {
	public final @NotNull Resource id;
	public final @NotNull Map<String, String> state;

	public BlockState(@NotNull Resource id, @NotNull Map<String, String> state) {
